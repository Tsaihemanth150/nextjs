...
<footer class="bg-text-gray-500 dark:bg-gray-900">
   ...
   { <div class="px-4 py-6 rounded-xl bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <Link  href="/">MyCook</Link>. All Rights Reserved.
        </span>
