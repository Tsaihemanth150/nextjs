...
Indulge your senses in a world of exquisite flavors at MyCook, where passion meets innovation in every dish. We are not just an online restaurant; we are your culinary companion on a gastronomic journey like no other. Whether you're a food enthusiast or someone seeking a delightful dining experience, MyCook is your go-to destination for mouthwatering delights.</p>
      
 </div>
 <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
      <img alt="feature" class="object-cover object-center h-full w-full" src="home.jpg"/>
    </div>
    <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
      ...
      <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5">
        ...
        <div class="flex-grow">
          <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Explore Our Menu</h2>
          ...
          <a href='/fooditems' class="mt-3 text-indigo-500 inline-flex items-center">View
      ...
      <div class="flex flex-col mb-10 lg:items-start items-center">
        ...
        <div class="flex-grow">
          <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Order with Ease</h2>
      ...
      <div class="flex flex-col mb-10 lg:items-start items-center">
        ...
        <div class="flex-grow">
          <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Exclusive Offers and Discounts</h2>
          <p class="leading-relaxed text-base">At MyCook, we believe in making exceptional dining experiences accessible to all. Enjoy exclusive offers, discounts, and loyalty rewards that add an extra layer of delight to your MyCook journey.</p>
          <a class="mt-3 text-indigo-500 inline-flex items-center">Learn More
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
